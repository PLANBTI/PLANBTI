            ...
            public void run(String... args) throws Exception {
                ...
                for(int i=0; i<16; i++) {
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(25000)
                            .count(10)
                            .imageUrl("https://planbti.cdn.ntruss.com/자엽풍년화.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .count(100)
<<<<<<< HEAD
                            .imageUrl("https://planbti.cdn.ntruss.com/스킨답서스.gif")
=======
                            .imageUrl("https://planbti.cdn.ntruss.com/스킨답서스.jpg")
>>>>>>> e694d30 (feat : About, Main 페이지)
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(18000)
                            .count(10)
                            .imageUrl("https://planbti.cdn.ntruss.com/피쉬본 선인장.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(35000)
                            .count(20)
                            .imageUrl("https://planbti.cdn.ntruss.com/립살리스.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(10000)
                            .count(10)
                            .imageUrl("https://planbti.cdn.ntruss.com/브랜티아넘.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(40000)
                            .count(20)
                            .imageUrl("https://planbti.cdn.ntruss.com/소요카제.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(22000)
                            .count(10)
                            .imageUrl("https://planbti.cdn.ntruss.com/동백나무.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(28000)
                            .count(20)
                            .imageUrl("https://planbti.cdn.ntruss.com/물티피다.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(15000)
                            .count(15)
                            .imageUrl("https://planbti.cdn.ntruss.com/아단소니.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(30000)
                            .count(10)
                            .imageUrl("https://planbti.cdn.ntruss.com/plant5.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(18000)
                            .count(15)
                            .imageUrl("https://planbti.cdn.ntruss.com/plant6.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(14500)
                            .count(20)
                            .imageUrl("https://planbti.cdn.ntruss.com/plant7.jpg")
                    ...
                    productRepository.save(Product.builder()
                            ...
                            .salePrice(28000)
                            .count(12)
                            .imageUrl("https://planbti.cdn.ntruss.com/plant8.jpg")
